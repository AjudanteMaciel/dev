...
declare -A HL_CONTENT_TEMPLATE=(
  USER   '%{$bold$red%} ...' # consider "%{$bold$red%}..." or ' '
  HOST   '%{$bold$yellow%}󰇅 ...' # consider "%{$bold$yellow%}..." or ' '
  VENV   '%{$bold$green%} ...' # consider "%{$bold$green%}..." or ' '
  PATH   '%{$bold$blue%} ...' # consider "%{$bold$blue%}..." or ' '
  BRANCH '%{$bold$cyan%}     ...' # consider "%{$bold$cyan%}..." or ' '
  STATUS "%{$bold$magenta%}..."
  # ...
)
