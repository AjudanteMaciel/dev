...
# Só inicializa oh-my-posh se estiver instalado
if command -v oh-my-posh &> /dev/null; then
  # eval "$(oh-my-posh init bash --config 'https://raw.githubusercontent.com/AjudanteMaciel/dev/refs/heads/main/workspace/windos_terminal/oh-my-posh%20themes/kushal.omp.json')"
